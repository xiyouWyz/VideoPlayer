...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(com.example.videoplayer.R.layout.jc_progress_dialog, null);
            View content = localView.findViewById(R.id.content);
            content.setRotation(90);
            mDialogProgressBar = ((ProgressBar) localView.findViewById(com.example.videoplayer.R.id.duration_progressbar));
            mDialogSeekTime = ((TextView) localView.findViewById(com.example.videoplayer.R.id.tv_current));
            mDialogTotalTime = ((TextView) localView.findViewById(com.example.videoplayer.R.id.tv_duration));
            mDialogIcon = ((ImageView) localView.findViewById(com.example.videoplayer.R.id.duration_image_tip));
            mProgressDialog = new Dialog(getContext(), com.example.videoplayer.R.style.jc_style_dialog_progress);
            ...
            localLayoutParams.x = getResources().getDimensionPixelOffset(com.example.videoplayer.R.dimen.jc_progress_dialog_margin_top) / 2;
